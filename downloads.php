    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        ...
        <div href="./img/interfaces/kaisen-linux_plymouth.jpg" target="_blank" class="swiper-slide">
         <img src="./img/interfaces/kaisen-linux_plymouth.jpg" alt="kaisen linux plymouth no bgrt theme">
          <div class="legend"><p>Plymouth without BGRT theme</p></div>
        </div>
        ...
        <div href="./img/interfaces/kaisen-linux_mate_maintenance_menu.jpg" target="_blank" class="swiper-slide">
         <img src="./img/interfaces/kaisen-linux_mate_maintenance_menu.jpg" alt="kaisen linux mate with technicians tools menu" >
        ...
        <div href="./img/interfaces/kaisen-linux_lxqt_desktop.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_lxqt_desktop.jpg" alt="kaisen linux with LXQT desktop">
           <div class="legend"><p>LXQT default desktop</p></div>
        </div>

        <div href="./img/interfaces/kaisen-linux_lxqt_sysadmin_menu.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_lxqt_sysadmin_menu.jpg" alt="kaisen linux LXQT with sysadmin tools menu">
           <div class="legend"><p>LXQT sysadmin tools menu</p></div>
        </div>

        <div href="./img/interfaces/kaisen-linux_lxqt_miscellaneous-menu.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_lxqt_miscellaneous-menu.jpg" alt="kaisen linux LXQT with miscellaneous tools menu">
        ...
        <div href="./img/interfaces/kaisen-linux_kde_cloud_menu.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_kde_cloud_menu.jpg" alt="kaisen linux KDE with cloud menu">
           <div class="legend"><p>KDE cloud menu</p></div>
        </div>

        <div href="./img/interfaces/kaisen-linux_kde_with_kaisen-conky_package.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_kde_with_kaisen-conky_package.jpg" alt="kaisen linux KDE with kaisen-conky">
           <div class="legend"><p>KDE with the kaisen-conky package installed</p></div>
        </div>

        <div href="./img/interfaces/kaisen-linux_kde_zsh_systemd.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_kde_zsh_systemd.jpg" alt="kaisen linux with ZSH completion for systemd">
           <div class="legend"><p>Use ZSH completion for Systemd</p></div>
        </div>

        <div href="./img/interfaces/kaisen-linux_kde_zsh_apt.jpg" target="_blank" class="swiper-slide">
          <img src="./img/interfaces/kaisen-linux_kde_zsh_apt.jpg" alt="kaisen linux zsh completion for APT">
    ...
    <div class="row">
      ...
      <div class="section-heading col-md-4 col-sm-4 col-12">
        ...
        <div class="text-content-big mt-20">
          ...
          Default desktop environment: KDE<br>
          Others desktop environments: MATE, XFCE, LXQT<br>
          ...
          Last changelog <a href="https://kaisenlinux.org/blog/kaisenlinuxrolling2.3.php" target="_blank">here</a><br>
          </div>
